<template>
  <div>
    ...
    <el-input placeholder="支付类型" class="a2"></el-input><br /><br>
        ...
        <el-table :data="datalist" style="width: 100%">
          ...
          <el-table-column label="支付类型">
            <template scope="scope">
              ...
              <el-tag type="danger" v-if="scope.row.payType == 2">支付宝</el-tag>
    ...
    <el-dialog title="添加用户" :visible.sync="dialogFormVisible1">
      <el-form :model="bjlist" ref='form' :rules="rules">
        <el-form-item label="会员卡号" prop="cardNum">
          <el-input v-model="bjlist.cardNum" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="会员姓名" prop="name">
          <el-input v-model="bjlist.name" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="支付类型" prop="payType">
          <el-input v-model="bjlist.payType" autocomplete="off"></el-input>
        </el-form-item>

        <el-form-item label="出生日期">
          <el-input v-model="bjlist.birthday" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="手机号">
          <el-input v-model="bjlist.phone" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="可用积分">
          <el-input v-model="bjlist.integral" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="开卡金额">
          <el-input v-model="bjlist.money" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="地址">
