<template>
  <div>
    ...
    <el-input placeholder="商品管理" class="a2"></el-input>
    <el-input placeholder="商品编号" class="a2"></el-input>
    <el-input placeholder="选择供应商" class="a2"></el-input><br /><br>
    ...
    <el-card class="box-card">
      ...
      <el-dialog title="供应商添加" :visible.sync="dialogFormVisible1">
        <el-form :model="bjlist" :rules="rules" ref="form">
          ...
          <el-form-item label="商品编码" prop="code">
            <el-input v-model="bjlist.code" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="商品规格">
            <el-input v-model="bjlist.spec" autocomplete="off"></el-input>
          </el-form-item>

          <el-form-item label="零售价" prop="retailPrice">
            <el-input v-model="bjlist.retailPrice" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="进货价">
            <el-input v-model="bjlist.purchasePrice" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="库存数量">
            <el-input v-model="bjlist.storageNum" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="供应商">
            <el-input v-model="bjlist.supplierName" autocomplete="off"></el-input>
          </el-form-item>
        </el-form>
        <div slot="footer" class="dialog-footer">
