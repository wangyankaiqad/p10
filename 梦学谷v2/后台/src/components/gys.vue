<template>
  <div>
    ...
    <el-input placeholder="联系电话" class="a2"></el-input><br /><br>
    ...
    <el-card class="box-card">
      ...
      <el-dialog title="供应商编辑" :visible.sync="dialogFormVisible1">
        <el-form :model="bjlist" ref="form" :rules="rules">
          ...
          <el-form-item label="联系人" prop="linkman">
            <el-input v-model="bjlist.linkman" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="联系电话" prop="payType">
          ...
          <el-form-item label="备注">
            <el-input v-model="bjlist.remark" autocomplete="off"></el-input>
          </el-form-item>
        </el-form>
        <div slot="footer" class="dialog-footer">
